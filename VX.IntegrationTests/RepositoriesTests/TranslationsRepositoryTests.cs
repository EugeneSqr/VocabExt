...
namespace VX.IntegrationTests.RepositoriesTests
{
    ...
    internal class TranslationsRepositoryTest : DataLayerTestsBase<ITranslationsRepository, TranslationsRepository>
    {
        ...
        public void UpdateTranslationTest()
        {
            ...
            IManyToManyRelationship updatedTranslation = SystemUnderTest.SaveTranslation(goodExistByIdTranslation, out action);
        ...
        {
            ServiceOperationAction action;
            var createdTranslation = SystemUnderTest.SaveTranslation(goodNonExistTranslation, out action);
        ...
        {
            ServiceOperationAction action;
            IManyToManyRelationship updatedTranslation = SystemUnderTest.SaveTranslation(goodNonExistByIdTranslation, out action);
            Assert.AreEqual(ServiceOperationAction.Update, action);
            Assert.AreEqual(1, updatedTranslation.Id);
            Assert.AreEqual(1, updatedTranslation.SourceId);
        ...
        {
            ServiceOperationAction action;
            Assert.Throws<ValidationFailedException>(() => SystemUnderTest.SaveTranslation(badSourceTranslation, out action));
        }
        ...
        {
            ServiceOperationAction action;
            Assert.Throws<ValidationFailedException>(() => SystemUnderTest.SaveTranslation(badTargetTranslation, out action));
        }
