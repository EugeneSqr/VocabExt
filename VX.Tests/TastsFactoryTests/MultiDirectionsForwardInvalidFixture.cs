...
{
    [TestFixture(Description = "Forward direction fixture. Validator returns always invalid.")]
    internal class MultiDirectionsForwardInvalidFixture : MultiDirectionsForwardFixture
    {
        public MultiDirectionsForwardInvalidFixture()
        {
